                    ...
                    <div class="g-0 lg:flex lg:flex-wrap">
                        ...
                        <div class="px-4  w-6/12">
                            <div class="flex flex-col md:mx-6 md:p-12">
                                ...
                                <form action="{{ route('registrasi.update', Crypt::encryptString($registrasi->id_registrasi)) }}" method="POST"
                                    ...
                                    <div class="mb-[18px] form-group">
                                        <input
                                            class="w-full h-[52px] p-2 border-0  border-b border-gray-500 outline-none"
                                            type="text" placeholder="Nama Kelompok Tani" id="nama_keltani"
                                            name="nama_keltani" value="{{ $registrasi->nama_keltani }}" />
                                    </div>
                                    ...
                                    <div class=" mb-[18px]">
                                        <input
                                            class="w-full h-[52px] p-2 border-0 border-b border-gray-500 outline-none"
                                            type="text" placeholder="Nama Ketua" id="nama_ketua" name="nama_ketua" value="{{ $registrasi->nama_ketua }}" />
                                    </div>
                                    ...
                                    <div class=" mb-[18px]">
                                        <input
                                            ...
                                            name="luas_hamparan" value="{{ $registrasi->luas_hamparan }}"/>
                                    </div>
                                    ...
                                    <div class=" mb-[18px]">
                                        <input
                                            ...
                                            name="jumlah_anggota" value="{{ $registrasi->jumlah_anggota }}" />
                                    </div>
                                    ...
                                    <div class=" mb-[18px]">
                                        <input
                                            ...
                                            name="alamat_keltani" value="{{ $registrasi->alamat_keltani }}"/>
                                    </div>
                                    ...
                                    <div class="mb-[18px] relative">
                                        <div class="relative">
                                            <select name="nama_kecamatan" id="nama_kecamatan"
                                                ...
                                                <option selected value="{{ $registrasi->id_kecamatan }}">{{ $registrasi->nama_kecamatan }}</option>
                                                @foreach ($kecamatan as $val)
                                                    @if ($val->id_kecamatan == $registrasi->id_kecamatan)
                                                        <option class="hidden" value="{{ $val->id_kecamatan }}">{{ $val->nama_kecamatan }}</option>
                                                    @else
                                    ...
                                    <input type="number" class="hidden" name="status_validasi" value="1">
                                        ...
                                        <label for="dropzone-file"
                                            ...
                                            <div class="flex flex-row items-center justify-center gap-2 pt-5 pb-6">
                                                <div id="file-name"
                                                    ...
                                                    <p id="textcontent">
                                                        {{ basename($registrasi->bukti_legalitas) }}
                                                    </p>
                                                </div>
                                            </div>
                                    ...
                                    <div>
                                        <label for="catatan_validasi" class="font-[montserrat]">Catatan Dinas :</label>
                                        <textarea class="resize-none w-[440px] h-[80px] p-2 mt-2 rounded-[6px]" name="catatan_validasi" id="catatan_validasi" disabled>{{ strip_tags($registrasi->catatan_validasi) }}</textarea>
                                    </div>
                                    <!-- Submit button -->
