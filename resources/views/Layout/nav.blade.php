...
<body>
    <nav class="flex items-center justify-between p-6 lg:px-8 mx" aria-label="Global">
        ...
        <div class="lg:flex lg:gap-x-12">
            <a href="{{ route('homepage') }}" class="font-semibold leading-6 text-gray-900"
                style="font-size:20px">Home</a>
            <a href="{{ route('pemberitahuan.landing') }}" class="font-semibold leading-6 text-gray-900"
                style="font-size:20px">Berita</a>
