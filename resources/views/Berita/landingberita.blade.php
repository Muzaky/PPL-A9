                        ...
                        @foreach ($data as $val)
                            <a href="{{ route('pemberitahuan.detail',  ['slug' => Str::slug($val->judul_informasi), 'id' => $val->id_informasi]) }}"
                                ...
                                <div class="flex flex-col h-full">
                                    <div class="flex flex-col items-start justify-between p-4 leading-normal w-[550px] text-wrap">
                                        ...
                                        <div class="mb-3 font-normal text-gray-700 dark:text-gray-400 text-start overflow-ellipsis">
