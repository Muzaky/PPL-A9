...
@section('content')
    ...
    <body class="bg-slate-200">
        ...
        <section class="flex flex-col font-[Montserrat] items-center bg-slate-200 h-full">
                <div
                ...
                @foreach ($pengajuan as $val)
                    <div class="flex flex-col items-center">
                        <a href="{{ route('pengajuan.show', Crypt::encryptString($val->id_pengajuan) ) }}"
                            ...
                            <img class="object-cover w-48 h-40 rounded-[20px]"
                                src="{{ optional($val->informasi)->gambar_informasi ? Storage::url($val->informasi->gambar_informasi) : 'fallback-image-url.jpg' }}"
                                alt="">
