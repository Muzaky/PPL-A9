...
@section('content')
    <section>
        <div class="flex flex-col m-4">
            <h1 class="text-[40px] font-semibold text-[#33765F] font-[Montserrat] ">Pelaporan Bantuan Bibit Horikultura
            </h1>
                ...
                <table class="table-auto min-w-full divide-y divide-gray-200" id="tablezz">
                    ...
                    <tbody>
                        ...
                        @foreach ($data as $val)
                            <tr class="bg-white">
                                ...
                                <td class="tb-col tb-col-md justify-center text-center">
                                    <div class="px-2 py-1 fs-6 lh-sm object-fill">
                                        <a href="{{ Storage::url($val->dokumentasi_pelaporan) }}">
                                            Lihat Dokumentasi
                                ...
                                <td class="tb-col tb-col-md justify-center py-4 flex gap-x-2 ">
                                    <a href="#" onclick="editButton({{ $val->id_pelaporan }})"
                            ...
                            <div id="editModal{{ $val->id_pelaporan }}"
                                ...
                                <div
                                    ...
                                    <button onclick="hideEditModal({{ $val->id_pelaporan }})"
                                    ...
                                    <div class="flex flex-col items-center justify-center px-10 py-4 pt-0">
                                        <form class="flex justify-center items-center flex-col"
                                            action="{{ route('pelaporan.updatedinas', $val->id_pelaporan) }}"
                                                ...
                                                <div class="w-full flex items-center justify-center lg:w-6/12 px-4">
                                                    <div class="flex flex-col w-full mb-3 justify-center items-center">
                                                        ...
                                                        <input type="date" name="tanggal_pelaporan"
                                                            ...
                                                            value="{{ $val->tanggal_pelaporan }}" placeholder="">
                                                    </div>
                                                </div>
                                                ...
                                                <a href="{{ Storage::url($val->dokumentasi_pelaporan) }}"
                                                    ...
                                                    <div class="flex flex-row items-center justify-center gap-2 pt-5 pb-6">
                                                        <div id="file-name"
                                                            ...
                                                            <p id="textcontent">
                                                                {{ basename(Storage::url($val->dokumentasi_pelaporan)) }}
                                                            </p>
                                                        </div>
                                                    </div>
                                                </a>
                                            </div>
                                            <label class="block uppercse text-blueGray-600 text-xs font-bold mb-2"
                                                htmlfor="grid-password">
                                                Catatan Validasi
                                            </label>
                                            ...
                                            <textarea name="catatan_validasi" id="catatan_validasi"
                                                ...
                                                placeholder="Masukkan catatan disini...">{{ strip_tags($val->catatan_validasi) }}</textarea>
                                            <button type="submit"
