...
<body class="flex items-center justify-center h-full py-4">
        ...
        <div class="flex items-center justify-center photo-container">
            <div class="upload w-[200px]">
                @if ($registrasi->foto_profil == null)
                    <img src="{{ asset('user.png') }}" alt="" class="border-2 rounded-[50%] w-[200px] h-[200px]"
                        id="profilepicture">
                @else
                ...
                <div class="flex flex-row">
                    ...
                    <div class="bottom-0 round right-0 -mt-4 mr-4 bg-[#204E51] w-8 h-8 overflow-hidden rounded-[50%] leading-[32px] text-center hover:bg-[#80ed99]">
                        <form id="fotokeltan" action="{{ route('fotoprofil.update', $registrasi->id_registrasi) }}"
                        ...
                        <div class="bg-[#53C341] rounded-[8px] px-2 py-2 flex flex-col text-white">
                            <div class="flex flex-row items-center justify-between">
                                <p class="text-[20px] px-2 font-[poppins] font-semibold">Data
                                    Profil</p>
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" class="mr-5"
