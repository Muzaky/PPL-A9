...
<body>
    ...
    <div class="flex flex-col items-center justify-center">
        <div class="flex flex-row items-center justify-between w-full px-12 rounded shadow-lg h-80 bg-image">
            <style>
                .bg-image {
            ...
            <div class="flex flex-col justify-center w-full h-full font-bold bg-transparent">
                ...
                @elseif ($usercount != 0)
                    ...
                    @elseif ($registrasi->status_validasi == 2)
                        <div class="flex w-[400px] text-[36px] text-white">Halo,
                            {{ $registrasi->nama_keltani }} !
                        </div>
                        <div class="flex text-[20px] text-white">Selamat datang di aplikasi Bibitani !
                        </div>
                    @endif
                @endif
            </div>
